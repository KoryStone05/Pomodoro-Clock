...
function Clock() {
    ...
    this.displayCurrentTime = function() {
        ...
        //Update the class for the process radial to be either break or session depending on what mode we're in
    ...
    //Function to add or subtract 60 seconds from the session time whenever the plus or minus button are interacted with
